    ...
    <div class="container">
        <div class="card mt-3">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">Editar usuario</div>
                </div>
            </div>
            <div class="card-body">
              <form id="edituserform">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <?=$theUser->records->username?>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-4 col-form-label" for="fullname">Nombre Completo</label>
                  <div class="col-8">
                    <input id="fullname" value="<?=$theUser->records->fullname?>" name="fullname" type="text" class="form-control" required="required">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-8">
                    <div class="custom-control custom-checkbox custom-control-inline">
                      <input name="admin" id="admin" <?=($theUser->records->admin==1)?'checked':'';?> type="checkbox" class="custom-control-input" value="true">
                ...
                <div class="form-group row">
                  <div class="offset-4 col-8">
                    ...
                    <button name="submit" type="submit" class="btn btn-primary ml-2">Editar Usuario</button>
                  </div>
                </div>
              </form>
            </div>
    ...
    <script lang="javascript">
      $( "#edituserform" ).submit(function( event ) {
        $.ajax({
            method: "POST",
            url: "/user/updateUser",
            data: { id: <?=$id?>, fullname: $('#fullname').val(), password: $('#password').val(), admin: $('#admin').prop('checked')},
            statusCode: {
                401: function(msg) {
